...
static const char *rofi[]     = {"rofi", "-show", "drun", "-width", "35", "-show-icons", "-icon-theme", "Zafiro-Nord-Black-Blue", NULL };
...
static Button buttons[] = {
	...
	{ ClkStatusText,        0,              Button2,        spawn,          SHCMD("alacritty -e nvim ~/.local/src/slstatus/config.h") },
